...
# once published:
flatpak install flathub io.github.gerardoarias.gnote-calendar
```
...
flatpak/        -> io.github.gerardoarias.gnote-calendar.json 6.9 + metainfo.xml
...
- **v2.2:** CalDAV, `QML` optional, `AppStream` Flathub publish `flatpak install flathub io.github.gerardoarias.gnote-calendar`.
