...
- Packaging: `control 2.0.0` `Recommends: pyside6|pyqt5|pyside2`, `.deb 700K` `portable 1.7M` `AppImage stub`, `flatpak 6.9 org.kde.Platform` `io.github.gerardoarias.gnote-calendar.json`, `install.sh` Qt detect, `legacy/gui_gtk4.py` deprecado
